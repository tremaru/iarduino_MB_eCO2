...
//   modbus.setTypeMB( MODBUS_RTU );                                                              //   Указываем тип протокола Modbus: MODBUS_RTU (по умолчанию), или MODBUS_ASCII.
                                                                                                  //
//   Получаем название модуля с адресом 6:                                                        //
     int8_t lenName = modbus.getName(6);                                                          //   Функция возвращает длину строки с названием устройства, доступную для чтения функцией read() и available().
     if( lenName>0 ){                                                                             //
